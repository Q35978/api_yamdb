...
class User(AbstractUser):
    ...
    role = models.CharField(
        verbose_name='Роль',
        max_length=DEFAULT_ROLE_FIELD_LENGTH,
        choices=ROLES,
        default='user'
    )
    ...
    def is_administrator(self):
        return (self.role == self.ROLE_NAME_ADMIN
                or self.is_staff
    ...
    def is_moderator(self):
        return (self.role == self.ROLE_NAME_MODERATOR
                or self.is_superuser
                )
    ...
    class Meta(PubDateIdOrder.Meta):
        ...
        constraints = [
            models.CheckConstraint(
                check=models.Q(score__range=(0, 10)), name='valid_score'
            ),
